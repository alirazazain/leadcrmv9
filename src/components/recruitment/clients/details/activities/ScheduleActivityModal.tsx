...
export function ScheduleActivityModal({ isOpen, onClose }: ScheduleActivityModalProps) {
      ...
      <div className="min-h-screen px-4 text-center">
        ...
        >
          <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200">
            <h2 className="text-xl font-semibold text-gray-900">Schedule an Activity</h2>
            <button
              onClick={onClose}
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => {
                    ...
                    setFormData(prev => ({ ...prev, attendees: options }));
                  }}
                  className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 transition-colors duration-200"
                >
                  {/* Add contacts and team members here */}
                </select>
              </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) => {
                        ...
                        setShowManualUrl(e.target.value === 'manual');
                      }}
                      className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 transition-colors duration-200"
                    >
